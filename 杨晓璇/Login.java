...
public class Login extends InitAppium {
	...
	return data.getTestDataByExcel("E://Xuanxuan//testData.xlsx", "Sheet1");
	}
    ...
    public void login1(){
    	...
    	Assertion.verifyEquals(flag,true,"帐号密码错误是否登录成功");
    }
    ...
    public void login2(){
        ...
        Assertion.verifyEquals(flag,true,"帐号密码过长是否登录成功");
    }
    /**
     * 测试帐号密码长度过短
     */
    ...
    public void login3(){
        ...
        Assertion.verifyEquals(flag,true,"帐号密码过短是否登录成功");
    }
    ...
    @Test(priority = 3)
    public void login4(){
        boolean flag = loginOperate.login("http://192.168.80.129:11443","帐号","密码");
    ...
    public void login6() {
        ...
        Assert.assertTrue(flag,"服务器帐号密码对的情况登录");
    }
    /**
     * 测试帐号不存在
     */
    ...
    public void login7() {
        ...
        Assert.assertTrue(flag,"帐号不存在对的情况登录");
    }
    ...
    public void login8() {
        ...
        Assert.assertTrue(flag,"服务器错误的情况登录");
    }
    ...
    public void login9() {
        ...
        Assert.assertTrue(flag,"服务器器为空的情况登录");
    }
    ...
    public void login10(){
        ...
        Assertion.verifyEquals(flag,true,"服务器为中文是否登录成功");
    }
}
