...
//		action.longPress(CopyMess());
//		Thread.sleep(2000);
//		action.click(Copy());
//		Thread.sleep(2000);
//		action.longPress(dialog());
//		Thread.sleep(2000);
//		action.click(view());
//		Thread.sleep(2000);
//		action.click(Plaster());
//		Thread.sleep(2000);
//		action.click(btn_send());
//		Thread.sleep(2000);
//	}
...
//		action.click(btn_add());
//		Thread.sleep(2000);
//		action.click(number1());
//		Thread.sleep(2000);
//		action.click(number2());
//		Thread.sleep(2000);
//		action.click(number3());
//		Thread.sleep(2000);
//		action.click(btn_define());
//		Thread.sleep(2000);
//		
...
//	//分享信息
//	public void ShareMess() throws InterruptedException {
//		action.longPress(word());
//		Thread.sleep(2000);
//		action.click(share());
//		Thread.sleep(2000);
